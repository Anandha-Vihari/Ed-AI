...
def navbar():
    ...
    image_path = r"/workspaces/Ed-AI/Static_Files/NavBar/Ed AI logo.png"
    ...
    if 'memory_cleared' not in st.session_state:
        learn_Image_list_json_path = r"/workspaces/Ed-AI/dynamic files/Main_pages/Recommendations/Learn_Recommendation.json"
        ...
        Practice_MCQ_page_Image_list_json_path = r"/workspaces/Ed-AI/dynamic files/Main_pages/Recommendations/Practice_MCQ_Recommendation.json"
        ...
        Practice_Coding_page_Image_list_json_path = r"/workspaces/Ed-AI/dynamic files/Main_pages/Recommendations/Practice_Coding_Problems_Recommendation.json"
